...
def merge_gridded_flow_data(gridded_dir, out_dir, start_year=1982, end_year=2021, glob='glob',
                            join_key='STAID'):
...
if __name__ == '__main__':
    ...
    extracts = '/media/research/IrrigationGIS/mihms/ee_extracts/raw'
    data_tables = '/media/research/IrrigationGIS/mihms/ee_extracts/concatenated'
    merge_gridded_flow_data(extracts, data_tables, start_yr - 5, end_yr, glob='smith')
# ========================= EOF ====================================================================
