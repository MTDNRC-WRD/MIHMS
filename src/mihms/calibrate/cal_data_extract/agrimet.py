...
if __name__ == '__main__':
    ...
    csv_ = '/home/dgketchum/PycharmProjects/MIHMS/example/data/smith_3000/input/agrimet_wssm.csv'
    s, e = '1995-01-01', '2023-12-31'
    ag = Agrimet(start_date=s, end_date=e, station='wssm')
    ag.region = 'great_plains'
    sta_df = ag.fetch_met_data()
    sta_df.columns = sta_df.columns.get_level_values(0)
    sta_df.to_csv(csv_)
